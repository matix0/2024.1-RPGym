...
import { ModalBackground, ModalContainer, CloseButton, ModalContent, ActiveButton, Input, CaloTem } from './styles';
    ...
    <div>
        <ModalBackground>
            ...
            <ModalContent>
                ...
                <ActiveButton onClick={props.SuccessOnClick}>Registrar</ActiveButton>
            </ModalContent>
            </ModalContainer>
        </ModalBackground>
    </div>
