                ...
                <ModalContainer isOpen={isOpen}>
                    <ModalHeader>
                        ...
                        <DescriptionBox style={{ fontSize: `${fontSize}em`, marginTop: `${marginTop}em`, transition: 'font-size 0.2s ease, margin-top 0.2s ease' }}>
                            ...
                            <h2 style={{ opacity: "80%", marginTop: "-1em", fontWeight: "400" , marginBottom:"0"}}>Acompanhe o progresso!</h2>
                        </DescriptionBox>
                    </ModalHeader>
                    <ModalScrollableContent>
                        <BoxListPersons ref={boxListRef}>
                            {BancoFalsoPessoas.map((amigo, index) => (
                                <FriendBox key={index}>
                                    ...
                                    <GroupList>
                                        <p style={{ fontSize: "0.7em", fontWeight: "200" }}>Grupos em comum:</p> {amigo.gruposComuns.map((grupo, i) => (
